...
DOCKER_DIR_GENERATE := $(if $(BIND_DIR),-v "/home/ml/R/$(BIND_DIR)")
DOCKER_MOUNT := $(if $(BIND_DIR),-v "$(CURDIR)/$(BIND_DIR):/home/ml/R/$(BIND_DIR)")

DOCKER_MOUNT := $(if $(DOCKER_MOUNT),$(DOCKER_MOUNT),-v "/home/ml/R/$(BIND_DIR)")
